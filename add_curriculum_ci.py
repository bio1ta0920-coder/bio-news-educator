...
SECTION_MAP = {
    '암·종양학': [
        ('생명과학', '일반 선택', '항상성과 몸의 조절 — 면역과 면역항암'),
        ('고급 생명과학', '과학 계열', '생물의 조절과 방어 / 생명공학기술과 미래'),
    ],
    '신약개발·제약': [
        ('생물의 유전', '진로 선택', '생명공학기술 — 신약 개발과 임상시험'),
    ],
    '유전자편집·유전자치료': [
        ('생물의 유전', '진로 선택', '유전공학 — 유전자 편집·재조합'),
        ('고급 생명과학', '과학 계열', '생명공학기술과 미래 — CRISPR·유전자가위'),
    ],
    '재생의학·줄기세포': [
        ('고급 생명과학', '과학 계열', '생명공학기술과 미래 — 줄기세포와 재생의학'),
        ('생물의 유전', '진로 선택', '생명공학기술 — 줄기세포 활용'),
    ],
    '면역학·면역치료': [
        ('고급 생명과학', '과학 계열', '생물의 조절과 방어 — 면역'),
        ('생명과학', '일반 선택', '항상성과 몸의 조절 — 선천·후천 면역'),
    ],
    '신경과학': [
        ('고급 생명과학', '과학 계열', '생물의 조절과 방어 — 신경과 호르몬'),
    ],
    '감염병·백신': [
        ('생명과학', '일반 선택', '항상성과 몸의 조절 — 백신의 작용 원리'),
        ('고급 생명과학', '과학 계열', '생물의 조절과 방어 — 선천·후천 면역'),
    ],
    '생태학·환경과학': [
        ('생태와 환경', '교양', '환경 문제와 쟁점 — 생물다양성 보전'),
        ('기후변화와 환경생태', '융합 선택', '생태계 변화와 지속가능성'),
    ],
    '합성생물학·AI생물정보학': [
        ('생물의 유전', '진로 선택', '유전공학 — 유전자 재조합·합성생물학'),
        ('고급 생명과학', '과학 계열', '생명공학기술과 미래'),
    ],
    'RNA치료제': [
        ('생물의 유전', '진로 선택', '유전자 발현 — mRNA 전사·번역'),
        ('고급 생명과학', '과학 계열', '생명공학기술과 미래 — mRNA·RNA 치료제'),
    ],
    '내분비·대사질환': [
        ('세포와 물질대사', '진로 선택', '물질대사와 에너지 — 물질대사와 건강'),
        ('고급 생명과학', '과학 계열', '생물의 조절과 방어 — 호르몬과 항상성'),
    ],
    '영양학·대사': [
    ...
    '의료정책·규제': [
        ('현대사회와 윤리', '일반 선택', '생명윤리 — 과학기술과 사회적 책임'),
    ],
    '세포생물학·이미징': [
        ('세포와 물질대사', '진로 선택', '세포 — 세포의 구조와 기능'),
        ('고급 생명과학', '과학 계열', '생물의 구조와 에너지'),
    ],
}
...
order = {'일반 선택': 0, '진로 선택': 1, '융합 선택': 2, '과학 계열': 3, '교양': 4}
