...
4. 탐구 질문 답안은 '정답'이 아니라 '접근 방법'입니다.
   - inquiry_answers는 inquiry_questions와 개수가 같아야 하고, q_index는 0부터 순서대로입니다.
   - 결론을 알려주지 말고, 학생이 스스로 밟을 수 있는 경로를 쓰세요.
   - 고등학생이 실제로 할 수 있는 것만 제시하세요(문헌 조사, 공개 데이터, 학교 실험실 수준의
     대체 실험, 모형 제작 등). 대학 실험실 장비가 필요한 방법은 대안과 함께 제시하세요.
5. 교육과정 준수: 반드시 **2022 개정 교육과정** 과목명·영역명만 사용하세요.
   - 아래 참고 자료의 과목 편제표에 있는 이름을 글자 그대로 쓰세요.
   - 2015 개정 명칭(생명과학Ⅰ, 생명과학Ⅱ, 생식과 유전, 유전자와 DNA, 진화와 다양성 등)은
     절대 사용 금지입니다. 「생명과학과 인간」은 존재하지 않는 과목입니다.
   - 「생태와 환경」은 과학과가 아니라 교양 교과입니다.
━━━━━━━━━━━━━━━━━━━━━━━━
...
{{
  "bio_field": "다음 중 가장 적합한 분야 하나만 선택 (정확히 이 중 하나로): 암·종양학 / 신약개발·제약 / 유전자편집·유전자치료 / 재생의학·줄기세포 / 면역학·면역치료 / 신경과학 / 감염병·백신 / 생태학·환경과학 / 합성생물학·AI생물정보학 / RNA치료제 / 내분비·대사질환 / 영양학·대사 / 진화·고생물학 / 의료정책·규제 / 세포생물학·이미징",
  ...
  "achievement_standards": {{
    "primary_subject": "2022 개정 과목명 > 영역명 형식으로 정확히 작성. 여러 개면 ' / '로 구분. 예: '생명과학 > 항상성과 몸의 조절 / 생물의 유전 > 생명공학기술'",
    "standards": [
    ...
    "cross_subject": [
      {{
        "subject": "타교과명 (수학/화학/물리학/지구과학/정보/국어/영어/사회/윤리/교양 중 하나)",
        "course": "그 교과에서 실제로 선택 가능한 2022 개정 과목명 (예: 확률과 통계, 화학 반응의 세계, 인공지능 기초, 현대사회와 윤리)",
        "connection": "이 기사와 해당 과목의 구체적 연계점"
      }}
    ]
  }},
  ...
  "inquiry_answers": [
    {{
      "q_index": 0,
      "approach": "위 탐구 질문 1을 어떻게 파고들지, 고등학생이 실제로 밟을 수 있는 순서로 3~5문장. 정답을 알려주지 말고 접근 경로를 쓸 것. 학생이 그대로 옮겨 적으면 학생부에 쓸 수 없는 글이 되어야 함",
      "needs": "필요한 자료·도구·사전 지식을 한 문장으로. 대학 실험실 장비가 필요하면 문헌조사·공개데이터·학교 실험실 수준의 대체 방법을 제시",
      "extend": "여기서 한 걸음 더 나가려면 무엇을 해볼 수 있는지 한 문장"
    }}
  ],
